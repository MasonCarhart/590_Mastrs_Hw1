...
stargazer(reg1, reg2, keep.stat = c('n', 'rsq'),title = "Regression Results",
          ...
          dep.var.labels = c('Girl Enrolled in Formal School Fall 2007', 'Boy Enrolled in Formal School Fall 2007'), type = 'latex', header = FALSE, float = TRUE,  notes = "S.E Clustered by village")
