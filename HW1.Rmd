...
af = af %>% mutate(af$nonoutlier, if_else(f07_num_ppl_hh_cnt > 20, if_else(f07_jeribs_cnt > 10 , if_else(f07_observed == 1 , if_else(s08_num_ppl_hh_cnt > 20, if_else(s08_jeribs_cnt > 10, if_else(s08_num_sheep_cnt > 50, 1, 0), 0), 0), 0), 0), 0))
