...
# Regression for near individuals
reg_test_near_g = felm(f07_test_observed ~ treatment + 
                   chagcharan | 0 | 0 | clustercode,
         data = af %>% filter( 
                              f07_observed == 1 &
                              nonoutlier == 1 &
...
# Regression for close individuals
reg_test_close_g = felm(f07_test_observed ~ treatment + 
                   chagcharan | 0 | 0 | clustercode,
         data = af %>% filter( 
                              f07_observed == 1 &
                              nonoutlier == 1 &
...
# Regression for not close individuals
reg_test_nclose_g = felm(f07_test_observed ~ treatment + 
                   chagcharan | 0 | 0 | clustercode,
         data = af %>% filter( 
                              f07_observed == 1 &
                              nonoutlier == 1 &
...
# Regression for far individuals
reg_test_far_g = felm(f07_test_observed ~ treatment + 
                   chagcharan | 0 | 0 | clustercode,
         data = af %>% filter( 
                              f07_observed == 1 &
                              nonoutlier == 1 &
...
# Regression for near individuals
reg_test_near_b= felm(f07_test_observed ~ treatment + 
                   chagcharan | 0 | 0 | clustercode,
         data = af %>% filter( 
                              f07_observed == 1 &
                              nonoutlier == 1 &
...
# Regression for close individuals
reg_test_close_b = felm(f07_test_observed ~ treatment + 
                   chagcharan | 0 | 0 | clustercode,
         data = af %>% filter( 
                              f07_observed == 1 &
                              nonoutlier == 1 &
...
# Regression for not close individuals
reg_test_nclose_b = felm(f07_test_observed ~ treatment + 
                   chagcharan | 0 | 0 | clustercode,
         data = af %>% filter( 
                              f07_observed == 1 &
                              nonoutlier == 1 &
...
# Regression for far individuals
reg_test_far_b = felm(f07_test_observed ~ treatment + 
                   chagcharan | 0 | 0 | clustercode,
         data = af %>% filter( 
                              f07_observed == 1 &
                              nonoutlier == 1 &
